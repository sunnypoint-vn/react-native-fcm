...
public class FIRMessagingModule extends ReactContextBaseJavaModule implements LifecycleEventListener, ActivityEventListener {
    ...
    private void registerTokenRefreshHandler() {
        String action = getReactApplicationContext().getPackageName() + ".FCMRefreshToken";
    ...
    private void registerMessageHandler() {
        String action = getReactApplicationContext().getPackageName() + ".ReceiveNotification";
        IntentFilter intentFilter = new IntentFilter(action);
    ...
    private void registerLocalMessageHandler() {
        String action = getReactApplicationContext().getPackageName() + ".ReceiveLocalNotification";
        IntentFilter intentFilter = new IntentFilter(action);
